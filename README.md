...
~30 seconds. No Node needed — downloads prebuilt Zig binaries, verifies SHA-256. Skip agent you no have. Safe to re-run.
...
# Windows (PowerShell)
irm https://raw.githubusercontent.com/JuliusBrussee/caveman/main/install.ps1 | iex -- --only openclaw
```
